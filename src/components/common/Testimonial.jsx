...
const Testimonial = () => {
  ...
  return (
    <div className={`py-16 w-full flex flex-col items-center justify-center gap-8 ${isDarkMode ? 'text-white' : 'bg-white text-gray-900'}`}>
      ...
      <div className="flex flex-wrap gap-8 justify-center gap-4 items-start w-full px-4 max-md:mt-10">
        <div className="flex flex-col grow shrink items-start px-6 py-12 bg-zinc-800 bg-opacity-10 min-w-[240px] rounded-[32px] w-[314px] max-md:px-5">
          ...
          <div className="self-stretch mt-8 text-base leading-6">
